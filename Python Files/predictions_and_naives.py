...
if __name__=="__main__":
    ...
    Predictor_19.get_data_and_training('../Data_pol2/merged_griddata2019.csv',0.95)
    ...
    def linear_predictor_drawing():
        ...
        # data_mse.index=['Nov-'+str(j) for j in range(1,31)]
    ...
    # linear_predictor_drawing() 
    
        # dates=random.sample(list(Predictor_19.real_demand.columns), 8)
    ...
    def linear_predictor_noise(Predictor_19,interval,missing,noise_level):
        # Predictor_19=eigen_prediction()
        # Predictor_19.get_data_and_training('../Data_pol2/merged_griddata2019.csv',0.95) # update for unknown bug
